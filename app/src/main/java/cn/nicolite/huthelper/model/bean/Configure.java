...
public class Configure {
    ...
    public Configure(Long id, String appRememberCode, String token, String city,
            ...
            String hao, String yudian, String yue, String libraryUrl,
            String testPlanUrl, String newTermDate) {
        this.id = id;
