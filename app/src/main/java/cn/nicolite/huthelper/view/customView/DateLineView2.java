...
public class DateLineView2 extends View {
    private int width;
    private int height;
    ...
    private int  color;
    public DateLineView2(Context context) {
        this(context, null);
    }

    public DateLineView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public DateLineView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
