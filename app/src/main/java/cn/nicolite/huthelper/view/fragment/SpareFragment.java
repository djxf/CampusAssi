...
public class SpareFragment extends BaseFragment {
    ...
    public static  SpareFragment  newInstance() {
...
//                            curClickView.setAlpha((float) 0.5);
    ...
    private class CourseInfoInitMessageHandler extends Handler {
        WeakReference<SpareFragment> mTable;

        public CourseInfoInitMessageHandler(SpareFragment table) {
            mTable = new WeakReference<SpareFragment>(table);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            List<Lesson> lessonList = daoSession.getLessonDao().queryBuilder()
                    .where(LessonDao.Properties.UserId.eq(Constants.USER_ID)).list();
            ...
            do {
                ...
                if (upperCourse != null) {
                    ...
                    final TextView lesson = new TextView(mTable.get().context);
