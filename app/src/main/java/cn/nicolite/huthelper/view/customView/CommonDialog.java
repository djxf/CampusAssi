...
public class CommonDialog {
    ...
    private TextInputEditText inputArea;//输入框1
    private TextInputEditText inputArea2;//输入框2
    private TextInputLayout inputRoot;
    private TextInputLayout inputRoot2;
    ...
    public CommonDialog(Context context) {
        ...
        inputArea2 = (TextInputEditText) view.findViewById(R.id.input_area2);
        inputRoot = (TextInputLayout) view.findViewById(R.id.input_root);
        inputRoot2 = (TextInputLayout) view.findViewById(R.id.input_root2);
    ...
    public CommonDialog input_setHint(String msg) {
        inputRoot.setVisibility(View.VISIBLE);
        inputRoot.setHint(msg);
        return this;
    }

    public CommonDialog input2_setHint(String msg) {
        inputRoot2.setVisibility(View.VISIBLE);
        inputRoot2.setHint(msg);
        return this;
    }

    public CommonDialog setInput2(String str) {
        inputRoot2.setVisibility(View.VISIBLE);
        inputArea2.setVisibility(View.VISIBLE);
    ...
    public String getInputText2() {
        return inputArea2.getText().toString();
    }
